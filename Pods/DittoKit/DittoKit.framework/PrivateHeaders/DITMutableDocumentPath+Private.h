...
@property (nonatomic, readonly, unsafe_unretained) struct Ditto_Document *documentHandle;
 ...
 */
+ (instancetype)mutableDocumentPathWithDocumentHandle:(struct Ditto_Document *)documentHandle
