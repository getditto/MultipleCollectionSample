...
/**
 ...
 This is the entrypoint for inserting documents into a collection, as well
...
/**
 ...
 @param content The new document to insert.
 @param id The ID to use for the document. If `NULL` then DittoKit will automatically assign an ID.
 @param error On input, a pointer to an error object. If an error occurs, this pointer
 is set to an actual error object containing the error information. You may specify nil for this
 parameter if you do not want the error information.
...
/**
 ...
 The file residing at the provided path will be copied into the DittoKit's
 store. The `DITAttachment` object that is returned is what you can then use
 to insert an attachment into a document.
...
/**
 ...
 will report changes to the status of the attachment as it attempts to
 download it. Assuming it succeeds in downloading the attachment it wall call
 the `onStatusChanged` block with a completed status object, which will hold
 ...
 @param onStatusChanged A block that will be called when the status of the attachment download
 changes.
